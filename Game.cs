...
public class Game
{
    public Game(string gameId, int rows, int columns, int timeInSeconds, Dictionary<string, int> timeLeftForPlayers, Dictionary<string, string> playgroundMap, List<GameMove> moves, List<string> playerIds)
    {
        GameId = gameId;
        Rows = rows;
        Columns = columns;
