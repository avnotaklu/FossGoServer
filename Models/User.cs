...
public class User
{
    ...
    [BsonElement(UserFieldNames.RefreshToken)]
    [BsonIgnoreIfNull]
    public string? RefreshToken { get; set; }

    public User(string? email, bool googleSignIn, string userName, string? fullName, string? bio, string? avatar, string? nationality, DateTime creation, DateTime lastSeen, string? passwordHash = null, string? refreshToken = null)
    {
        Email = email;
